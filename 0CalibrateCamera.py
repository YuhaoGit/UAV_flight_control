...
for iname in images:
    ...
    if board == True:
        ...
        corners_acc = cv2.cornerSubPix(
                ...
                winSize=(11, 11),
                zeroZone=(-1, -1),
                criteria=(cv2.TERM_CRITERIA_EPS + cv2.TERM_CRITERIA_MAX_ITER, 30, 0.001)) # Last parameter is about termination criteria
...
print('Calibration successful. Calibration file used: {}'.format('calibration4.pckl'))
print(a)
